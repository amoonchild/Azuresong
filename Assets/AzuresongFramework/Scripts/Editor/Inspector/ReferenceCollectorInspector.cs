...
//  Description：ReferenceCollectorInspector
//------------------------------------------------------------
using System;
using UnityEngine;
using UnityEditor;
...
namespace Azuresong.Editor
{
    ...
    public class ReferenceCollectorInspector : UnityEditor.Editor
    {
        ...
        private SerializedProperty m_ReferenceObjectsProperty = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginVertical();
            {
                ...
                {
                    //EditorGUILayout.LabelField("数量与实际对象不符，可能存在重名对象，请检查.", EditorStyles.boldLabel);   //数量
            ...
            EditorGUILayout.BeginVertical("box");
            {
                ...
                for (int i = 0; i < m_ReferenceObjectsProperty.arraySize;)
                {
                    ...
                    EditorGUILayout.BeginHorizontal();
                    {
                        ...
                        if (m_ReferenceCollector.GetGO(newKey) != property.objectReferenceValue)
                        {
                            changed = true;
                            bakColor = GUI.color;
