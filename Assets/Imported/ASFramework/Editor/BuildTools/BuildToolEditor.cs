...
namespace Azuresong.Editor.BuildTools
{
    public partial class BuildToolEditor : EditorWindow
    {
        ...
        {
            string path = Path.Combine(EditorBase.SettingsPath, m_ConfigurationName);
            ...
            if (_configuration == null)
            {
                ...
                if (!Directory.Exists(EditorBase.SettingsPath))
                {
                    Directory.CreateDirectory(EditorBase.SettingsPath);
                }
