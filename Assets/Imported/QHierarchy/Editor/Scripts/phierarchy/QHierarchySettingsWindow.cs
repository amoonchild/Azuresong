...
namespace qtools.qhierarchy.phierarchy
{
    ...
    {
        // STATIC
        [MenuItem("Tools/QHierarchy", false, 1001)]
        ...
        private void drawIndexComponentSettings()
        {
            if (drawComponentCheckBox(QSetting.ShowIndexComponent, "Index"))
            {
                Rect rect = getControlRect(0, 18);
                drawBackground(rect.x, rect.y, rect.width, 18 + 5);
                rect.x += 31;
                ...
                drawCheckBoxRight(rect, QSetting.ShowIndexComponentDuringPlayMode, "Show Index During Play Mode");
                drawSpace(5);
            }
        }
