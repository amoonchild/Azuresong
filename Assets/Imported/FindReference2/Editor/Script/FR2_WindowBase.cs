...
namespace vietlabs.fr2
{
	 ...
	 public abstract class FR2_WindowBase : EditorWindow, IWindow{
		...
		internal class Icon
        {
            ...
            public GUIContent LockOn;
			 ...
			 protected bool IsFocusingUses { get { return selectedTab == 0; } }
        protected bool IsFocusingUsedBy { get { return selectedTab == 1; } }
        public bool IsFocusingDuplicate { get { return selectedTab == 2; } }
        protected bool IsFocusingUnused { get { return selectedTab == 4; } }
        protected bool IsFocusingGUIDs { get { return selectedTab == 3; } }
        protected bool IsFocusingFindInScene { get { return selectedTab == 1; } }
        protected bool IsFocusingSceneToAsset { get { return selectedTab == 0; } }
        protected bool IsFocusingSceneInScene { get { return selectedTab == 1; } }

		public bool WillRepaint { get; set; }
        protected bool showFilter, showSetting, showIgnore;

		protected static GUIContent[] TOOLBARS = new GUIContent[]
        {
            new GUIContent("Uses"),
		...
		[SerializeField] protected bool lockSelection;
		...
		public void AddItemsToMenu(GenericMenu menu)
        {
            ...
            menu.AddDisabledItem(new GUIContent("FR2 - v2.3.1"));
 ...
 protected abstract void OnReady();
		...
		internal bool GetDrawConfig(IRefDraw refDrawer, out RefDrawConfig config)
        {
		 ...
		 internal bool GetDrawConfig(IRefDraw refTop, IRefDraw refBot, out RefDrawConfig config1, out RefDrawConfig config2)
        {
            bool drawTool = true;
		...
		protected void DrawFooter()
        {
            ...
            GUILayout.BeginHorizontal(EditorStyles.toolbar);
            {
                ...
                {
                    if (GUILayout.Button("Commit Selection [" + FR2_Selection.SelectionCount + "]", EditorStyles.toolbarButton))
                    {
                        FR2_Selection.Commit();
                    }
