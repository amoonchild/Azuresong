...
namespace SarsFramework.Runtime
{
    public class UGUIFormLogic : UIFormLogic
    {
        ...
        private OpenUIFormInfo _openInfo = null;

        public int UIFormId
        {
            get { return _uiFormId; }
        }


        public void Close()
        {
            SarsEntry.UI.CloseUIForm(UIForm);
        }
        ...
        protected override void OnInit(object userData)
        {
            ...
            _canvas.worldCamera = SarsEntry.UI.GetUICamera();
