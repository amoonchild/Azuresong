...
namespace SarsFramework.Runtime
{
    public static class SoundExtension
    {
        ...
        public static int? PlaySound(this SoundComponent soundComponent, string soundAssetName, 
            bool loop, SarsEntityLogic bindingEntity = null, object userData = null)
        {
            PlaySoundParams playSoundParams = PlaySoundParams.Create();
            playSoundParams.Priority = 64;
        ...
        public static bool IsMuted(this SoundComponent soundComponent, string soundGroupName)
        {
            ...
            {
                SarsLog.Warning("Sound group is invalid.");
                return true;
            }
            ...
            if (soundGroup == null)
            {
                SarsLog.Warning("Sound group '{0}' is invalid.", soundGroupName);
                return true;
            }
        ...
        public static void Mute(this SoundComponent soundComponent, string soundGroupName, bool mute)
        {
            ...
            SarsEntry.Setting.SetBool(Utility.Text.Format(Constant.Setting.SoundGroupMuted, soundGroupName), mute);
            SarsEntry.Setting.Save();
        }
        ...
        public static void SetVolume(this SoundComponent soundComponent, string soundGroupName, float volume)
        {
            ...
            SarsEntry.Setting.SetFloat(Utility.Text.Format(Constant.Setting.SoundGroupVolume, soundGroupName), volume);
            SarsEntry.Setting.Save();
        }
    }
}
